...
void instructions()
{
	cout << "This is the addition board game." << endl;
	cout << " A random number will be displayed and the player will have to choose 2 numbers" << endl;
	cout << "in form of row and column that will add up to that number." << endl;
...
void questions()
{
	cout << "Enter the row and columns as two numbers that will sum up to " << n << endl;
}
void user_input()
{
